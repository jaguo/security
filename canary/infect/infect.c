...
/*  400ead: 48 8b 55 f8             mov    -0x8(%rbp),%rdx
  400eb1:   48 89 d1                mov    %rdx,%rcx
  400eb4:   48 c1 f9 20             sar    $0x20,%rcx
  400eb8:   48 31 d1                xor    %rdx,%rcx
  400ebb:   64 33 0c 25 a0 02 00    xor    %fs:0x2a0,%ecx
  400ec2:   00 
  400ec3:   74 05                   je     400eca <main+0x136>
  400ec5:   e8 46 f9 ff ff          callq  400810 <__stack_chk_fail@plt>
  400eca:   c9                      leaveq 
  400ecb:   c3                      retq */
  /* This array contains the begin half self-encrypt stackguard assembly program. The "0xe9, 0x00, 0x00, 0x00, 0x00,"
 * instruction is a 32-bit jump to the end half, which needs to be modified to point
 * to an actual target.
 */
